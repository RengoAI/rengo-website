    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "Rengo AI is the AI deployment company for investment firms. Embedded alongside investment, finance, and operations teams, we turn fragmented knowledge into shared data infrastructure and deploy purpose-built agents and applications on top of it.",
          },
          {
            type: "paragraph",
            text: "Rengo gives teams access to their firm's collective intelligence, transforming institutional memory into an asset that compounds with every workflow, investment, and decision.",
          },
        ],
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "AI is fundamentally changing how engineering is performed. Engineers used to live on the factory line building the product. The job is now to be the one building the factory. This role is for people who are comfortable owning end-to-end technical outcomes but specifically can continue being impactful when given an ambiguous problem.",
          },
          {
            type: "paragraph",
            text: "You'll work on a small, high-caliber team building AI products for our clients. You'll set technical direction, write code, and be the person the team looks to when something is hard.",
          },
        ],
      },
      {
