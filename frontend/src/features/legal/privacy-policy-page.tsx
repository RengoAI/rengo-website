      ...
      <VStack gap={12} align="stretch">
        ...
        <VStack gap={5} align="stretch" w="full">
          ...
          >
            ...
            data privacy is very important to you. We have created this privacy
            policy (the "Privacy Policy") to describe how we collect and process
            information from and about you via our website at www.rengoai.com
            (the "Website") and when you otherwise interact with us
          ...
          >
            ...
            agree to be bound by this Privacy Policy. If you do not agree to (or
            cannot comply with) all of the terms of this Privacy Policy you may
          ...
          <Text
            ...
            color="ink.body"
          >
            We collect contact information through our Services, which typically
            includes your name, email address, phone number, and any information
            you provide in messages to us ("Contact Information"). We use
            Contact Information for purposes such as providing you with
            information about the Services, responding to your inquiries,
            sending you email alerts (including marketing emails), or providing
          ...
          >
            ...
            automatically collect certain information sent to us by the person's
            computer, mobile device, tablet, or any other device. For Visitors
            who are candidates for employment with us, please review the
            Workforce Privacy Notice attached hereto as Appendix 1 for more
          ...
          <Text
            ...
            color="ink.body"
          >
            We may also automatically collect other information when you access
            or use the Services such as (i) information about the device used;
            (ii) IP addresses; (iii) browser type and language; (iv) referring
            and exit pages and URLs; (v) date and time of access; (vi) the
            content viewed; (vii) the amount of time spent on particular pages;
            (viii) what features of the Services are used or visited; (ix)
            details of any purchases; (x) click stream information; and (xi)
          ...
          <Text
            ...
            color="ink.body"
          >
            To provide access to the Services while you are using an electronic
            device, we automatically collect geolocation information from your
            mobile device, your wireless carrier, or certain third-party service
            providers ("Geolocation Information"). You may control the
            collection of Geolocation Information through the user settings on
            your device.
          </Text>
          ...
          >
            ...
            information from third parties or when you visit, use, or access the
            Services from third-party websites. This includes any social media
            pages we may have on third-party services such as Twitter and
            LinkedIn.
          </Text>
          ...
          >
            ...
            evaluate your use of the Services, compile reports on activity,
          ...
          <Box pl={4}>
            <VStack gap={2} align="stretch">
              ...
              >
                ...
                problems, and detecting and protecting against error, fraud, or
          ...
          >
            ...
            communications by clicking on the "unsubscribe" hyperlink located on
            the bottom of any of our marketing emails.
          </Text>
          ...
          <Text
            ...
            color="ink.body"
          >
            Our Services are only available to individuals aged 18 or older, and
            we do not knowingly collect personal information from any person
            under the age of 18. If an individual under the age of 18 has
            provided us with Personal Information, a parent or guardian of that
            child may contact us and request that such information be deleted.
          </Text>
          ...
          >
            ...
            or use the Services. At this time, we do not monitor, recognize, or
            honor any opt-out or do not track mechanisms.
          </Text>
          ...
          >
            ...
            with whom they have an established business relationship have shared
            with third parties for direct marketing purposes. If you wish to
            submit a request pursuant to Section 1798.83, please contact us via
            email at legal@rengoai.com.
          </Text>
          ...
          >
            ...
            practices, or if you would like to exercise your rights and choices,
            please contact us at: legal@rengoai.com
          </Text>
