 ...
 */
export declare const useAuthTokenInterceptor: (axios: import("axios").AxiosInstance, config: import("./src/IAuthTokenInterceptorConfig").IAuthTokenInterceptorConfig) => void;
